...
<footer class="bg-primary text-white">
    <div class="grid grid-cols-2 md:grid-cols-3 gap-y-8 p-4 md:container md:mx-auto">
        <div class="flex flex-col">
            <h1 class="pb-4 font-bold">CATEGORIES</h1>
            <div class="flex flex-col text-sm">
                <a class="" href="#">blah</a>
                <a class="" href="#">blah blah</a>
                <a class="" href="#">blah blah blah</a>
                <a class="" href="#">blah blah blah blah</a>
            </div>
        </div>
        <div class="flex flex-col">
