<a href="#" class="border rounded-b-xl flex flex-col justify-center items-center space-y-4 hover:bg-gray-100">
    ...
    <div class="flex space-x-2">
        ...
        ?>
            <svg class="fill-current text-yellow-300 h-6 w-6" viewBox="0 0 20 20">
        ...
        ?>
            <svg class="fill-current text-gray-400 h-6 w-6" viewBox="0 0 20 20">
                <path d="M10 15l-5.878 3.09 1.123-6.545L.489 6.91l6.572-.955L10 0l2.939 5.955 6.572.955-4.756 4.635 1.123 6.545z" />
            </svg>
        <?php
        }
