    ...
    <header>
        ...
        <div class="bg-black text-white">
            <div class="container mx-auto flex justify-between items-center px-4 py-2">
                <h1>Free shipping on +3 items</h1>
                <div class="flex">
        ...
        <!-- navbar -->
        <div x-data="{ openMobileMenu: false }" class="bg-primary text-white">
            <div class="flex justify-between items-center py-4 px-4 md:container md:mx-auto">
