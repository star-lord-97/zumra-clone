...
Object(function webpackMissingModule() { var e = new Error("Cannot find module 'jquery'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(productsData.root_url + "/wp-json/api/v1/products" + currentLocation.search + is_taxonomy + taxonomy_name, function ($results) {
  Object(function webpackMissingModule() { var e = new Error("Cannot find module 'jquery'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())("#results-counter").html("\n    ".concat($results.paginationInfo.map(function (item) {
    return "<p>Showing ".concat(item.show_start, " - ").concat(item.show_end, " of ").concat(item.total_posts, " results</p> ");
  })));
  Object(function webpackMissingModule() { var e = new Error("Cannot find module 'jquery'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())("#product-results").html("\n    ".concat($results.Products.map(function (item) {
  ...
  Object(function webpackMissingModule() { var e = new Error("Cannot find module 'jquery'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())("#paginate-links").html("\n        ".concat($results.paginationInfo.map(function (item) {
